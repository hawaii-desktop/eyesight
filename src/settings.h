...
public:
    ...
    inline QStringList getShortCutsActs() const{return shortCutsOwner;}
    inline QStringList getShortCuts() const{return shortCuts;}
    ...
    inline void setShortCuts(const QStringList d, const QStringList e){shortCuts = d; shortCutsOwner = e;}
